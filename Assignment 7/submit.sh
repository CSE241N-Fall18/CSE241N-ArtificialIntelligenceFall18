...
# Useful variables
SECURE_FILE_LIST=("search.py") # Fill this based on the assignment
DELETE_FILE_LIST=("__pycache__" "test.py" "util.py" "graph.py") # Fill this list based on the assignment
ROLL_NO=$1
ASSIGNMENT_NO=7 # Fill this based on the assignment
...
# Encrypt files
for file in "${SECURE_FILE_LIST[@]}"; do
    if ! gpg2 --encrypt --recipient "$KEY_ID" "$file"; then
